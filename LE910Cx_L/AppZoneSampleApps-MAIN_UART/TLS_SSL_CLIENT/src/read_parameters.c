...
char gSERVER[MAX_PARAMS_STR_LEN];
UINT16 gSERVER_PORT;
char gCA_CERT_PATH[MAX_PARAMS_STR_LEN];
char gCLIENT_CERT_PATH[MAX_PARAMS_STR_LEN];
char gCLIENT_KEY_PATH[MAX_PARAMS_STR_LEN];
/* Macro =============================================================================*/
...
int readConfigFromFile(void)
{
  ...
  if(fd != -1)
  {
    ...
    else
    {
      ...
      gSERVER_PORT = atoi(_SERVER_PORT);
