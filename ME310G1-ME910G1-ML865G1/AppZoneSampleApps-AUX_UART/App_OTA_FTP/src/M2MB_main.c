...
void M2MB_main( int argc, char **argv )
{
  ...
  /*SET output channel */
  AZX_LOG_INIT();
  AZX_LOG_INFO("Starting FTP APP OTA demo app. This is v%s built on %s %s.\r\n",
        VERSION, __DATE__, __TIME__);


  taskID = azx_tasks_createTask((char*) "FTPOTA_TASK", AZX_TASKS_STACK_XL, 1, AZX_TASKS_MBOX_S, msgFTPTask);
