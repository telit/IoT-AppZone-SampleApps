...
Package Version: **1.1.22-G1**

Minimum Firmware Version: **37.00.007.1**
...
1. Have **37.00.007.1** FW version flashed (`AT#SWPKGV` will give you the FW version)
...
Sample application showcasing LWM2M client registration management using M2MB API. Debug prints on **USB0**
