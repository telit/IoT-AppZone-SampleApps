...
void M2MB_main( int argc, char **argv )
{
  ...
  /*SET output channel */
  AZX_LOG_INIT();
  AZX_LOG_INFO("Starting SMTP demo app. This is v%s built on %s %s.\r\n",
        VERSION, __DATE__, __TIME__);


  taskID = azx_tasks_createTask((char*) "SMTP_TASK", AZX_TASKS_STACK_XL*2, 1, AZX_TASKS_MBOX_M, M2M_msgSMTPTask);
