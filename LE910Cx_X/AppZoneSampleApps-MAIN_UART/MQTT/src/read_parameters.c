...
char gSSL_CERT_CA_NAME[MAX_PARAMS_STR_LEN];
char gSSL_CLIENT_NAME[MAX_PARAMS_STR_LEN];
char gCACERTFILE[MAX_PARAMS_STR_LEN];
char gCLIENTCERTFILE[MAX_PARAMS_STR_LEN];
char gCLIENTKEYFILE[MAX_PARAMS_STR_LEN];
UINT16 gUSER_SSL_AUTH;
char gMQTT_BROKER_ADDRESS[MAX_PARAMS_STR_LEN];
UINT16 gMQTT_BROKER_PORT;
UINT16 gMQTT_BROKER_PORT_SSL;
char gCLIENT_ID[MAX_PARAMS_STR_LEN];
char gCLIENT_USERNAME[MAX_PARAMS_STR_LEN];
char gCLIENT_PASSWORD[MAX_PARAMS_STR_LEN];
UINT16 gCLIENT_TIMEOUT_SEC;
UINT16 gCLIENT_KEEPALIVE_SEC;
char gSUB_TOPIC[MAX_PARAMS_STR_LEN];
char gSUB_TOPIC2[MAX_PARAMS_STR_LEN];
char gPUB_MESSAGE[MAX_PARAMS_STR_LEN];
